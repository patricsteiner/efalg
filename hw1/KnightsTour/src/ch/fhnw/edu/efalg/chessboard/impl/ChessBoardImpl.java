package ch.fhnw.edu.efalg.chessboard.impl;

import java.util.LinkedList;
import java.util.List;

import ch.fhnw.edu.efalg.chessboard.ChessBoard;
import ch.fhnw.edu.efalg.chessboard.ChessBoardListener;
import ch.fhnw.edu.efalg.chessboard.Field;
...
public final class ChessBoardImpl implements ChessBoard {
	 ...
	 * (non-Javadoc)
	 * @see
	 * ch.fhnw.edu.efficientalgorithms.chessboard.ChessBoard#addChessBoardListener(ch.fhnw.edu.efficientalgorithms.chessboard
	 * .ChessBoardListener)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * ch.fhnw.edu.efficientalgorithms.chessboard.ChessBoard#removeChessBoardListener(ch.fhnw.edu.efficientalgorithms
	 * .chessboard.ChessBoardListener)
	 */
	@Override
	public void removeChessBoardListener(final ChessBoardListener listener) {
		if (listener == null) {
			throw new NullPointerException();
		}
