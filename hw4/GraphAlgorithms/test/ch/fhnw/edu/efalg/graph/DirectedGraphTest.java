...
public abstract class DirectedGraphTest extends GraphTest {
	 ...
	 * (non-Javadoc)
	 * @see
	 * ch.fhnw.edu.efalg.graph.GraphTest#addEdge(ch.fhnw.edu.efalg.graph.vertices.IntegerVertex
	 * , ch.fhnw.edu.efalg.graph.vertices.IntegerVertex,
	 * ch.fhnw.edu.efalg.graph.edges.IntegerEdge, ch.fhnw.edu.efalg.graph.Graph)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * ch.fhnw.edu.efalg.graph.GraphTest#removeEdge(ch.fhnw.edu.efalg.graph.vertices.IntegerVertex
	 * , ch.fhnw.edu.efalg.graph.vertices.IntegerVertex,
	 * ch.fhnw.edu.efalg.graph.edges.IntegerEdge, ch.fhnw.edu.efalg.graph.Graph)
	 */
	@Override
	...
	/**
	 * Make sure the getEdge method doesn't find any
	 * non-existing back edges.
	 */
	@Test
	public void testGetEdge() {
		...
		assertEquals(e1, graph.getEdge(v1, v2));
		assertEquals(null, graph.getEdge(v2, v1));
	}
