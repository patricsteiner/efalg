...
public class GraphPanel<V extends Vertex, E extends Edge> extends JPanel implements ProgramStateListener<V, E>,
	 ...
	 * (non-Javadoc)
	 * @see
	 * ch.fhnw.edu.efalg.graph.ProgramStateListener#newGraphLoaded(ch.fhnw.edu.efalg.graph
	 * .Graph, ch.fhnw.edu.efalg.graph.Graph)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see ch.fhnw.edu.efalg.graph.gui.ProgramStateListener#graphChanged()
	 */
	@Override
	...
	public void stateChanged(State oldState, State newState) {
		// Remove selections.
		for (V v : programState.getGraph().getVertices()) {
			programState.getColorMapper().setVertexBorderColor(v, ColorMapper.DEFAULT_VERTEX_BORDER_COLOR);
		}
	}
	...
	public synchronized void paint(final Graphics g) {
		synchronized (programState) {
			...
			LocationMapper<V, E> mapper = programState.getLocationMapper();
			...
			for (V vertex : graph.getVertices()) {
				...
				graphics.setColor(programState.getColorMapper().getVertexBorderColor(vertex));
	 ...
	 * (non-Javadoc)
	 * @see
	 * ch.fhnw.edu.efalg.graph.gui.ColorMapperListener#newEdgeColor(ch.fhnw.edu.efalg.graph
	 * .Edge, java.awt.Color)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * ch.fhnw.edu.efalg.graph.gui.ColorMapperListener#newVertexColor(ch.fhnw.edu.efalg.graph
	 ...
	 * (non-Javadoc)
	 * @see
	 * ch.fhnw.edu.efalg.graph.gui.ColorMapperListener#newVertexBorderColor(ch.fhnw.edu.efalg.graph
	 * .Vertex, java.awt.Color)
	 */
	@Override
	public void newVertexBorderColor(final V v, final Color newColor) {
		repaint();
	}
	 ...
	 * (non-Javadoc)
	 * @see
	 * ch.fhnw.edu.efalg.graph.gui.LocationListener#locationChanged(ch.fhnw.edu.efalg.graph
	 * .Vertex)
	 */
	@Override
