 ...
 * @param <E> edge type
 */
public final class RandomGraphAction<V extends Vertex, E extends Edge> extends AbstractAction {
	 ...
	 */
	public RandomGraphAction(final ProgramState<V, E> state, final int numVertex, final int numOfEdgePerVertex) {
		if (state == null) {
	...
	public void actionPerformed(final ActionEvent e) {
		...
		// Clean the graph
		new EmptyAction<V, E>(state).actionPerformed(e);
