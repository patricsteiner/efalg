...
public class ExecuteAlgorithmAction<V extends Vertex, E extends Edge> extends AbstractAction implements
	 ...
	 */
	private final AbstractAlgorithm<V, E> algorithm;
	/**
	 ...
	 */
	public ExecuteAlgorithmAction(final AbstractAlgorithm<V, E> algorithm, final ProgramState<V, E> state,
	...
	private void execute() {
		new ResetColorsAction<V, E>(state).actionPerformed(null);
		
		String ret = algorithm.execute(new GraphAlgorithmData<V, E>(state));
		if (ret != null) {
